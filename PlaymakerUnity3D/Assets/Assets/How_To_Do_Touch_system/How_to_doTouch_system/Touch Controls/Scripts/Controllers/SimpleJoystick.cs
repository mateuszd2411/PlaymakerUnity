...
namespace How_To_Do
{
...
#endif
    {
        ...
        private void OnEnable()
        {
            ...
            How_To_Do_Touch_InputManager.RegisterVirtualAxis(HorizintalAxis);
            How_To_Do_Touch_InputManager.RegisterVirtualAxis(VerticalAxis);
        }
        ...
        private void OnDisable()
        {
            ...
            How_To_Do_Touch_InputManager.UnregisterVirtualAxis(HorizintalAxis);
            How_To_Do_Touch_InputManager.UnregisterVirtualAxis(VerticalAxis);
        }
