...
namespace How_To_Do
{
    ...
    /// </summary>
    public class How_To_Do_Touch_InputManager
    {
        private const float AlmostZero = 0.00000001f;

        private static How_To_Do_Touch_InputManager _instance;

        private static How_To_Do_Touch_InputManager Instance
        {
            get { return _instance ?? (_instance = new How_To_Do_Touch_InputManager()); }
        }

        private How_To_Do_Touch_InputManager() { }
